...
# 상품 ID 리스트
product_ids = ["112538672" ,"111217060","135006673","106642729","100485995","131367946","110641987","125732166","122560661","113525527"]
...
try:
    ...
    for product_id in product_ids:
        ...
        # 지정 요소 탐색 (2001번 요소 중 하나라도 만족)
        target_selectors = [
            "div:nth-child(2001) > div.css-vbvoj0.e13bai5o0 > div.css-1ecn1de.e13bai5o0 > div.css-o3enub.e1umgzx81 > div.css-4ku0lv.e13bai5o0 > p",
            "div:nth-child(2001) > div > div > div.css-o3enub.e1umgzx81 > div.css-4ku0lv.e13bai5o0 > p"
        ]
        found = False
        ...
        while current_review <= max_reviews:
            try:
                ...
                try:
                    review_data["상품평"] = driver.find_element(By.CSS_SELECTOR, f"div:nth-child({num}) > div > p.zds4_s96ru86.zds4_s96ru816.css-7id1z5.efip69o2").text
                except:
                    review_data["상품평"] = None
