...
# 상품 ID 리스트
# 10번(145496195) 버그 수정 필요 - 1001번째까지 가지않아 
...
product_ids = ["114953672","150442788","107062418"] #18,19,20



# 최대 리뷰 개수 설정
max_reviews = 1000
save_path = "/Users/jihoyeom/Desktop/projects/zigzag/hoodie"
product_num = 18 # 시작하고 싶은 product_id
...
try:
    ...
    for product_id in product_ids:
        ...
        # if product_id == "145496195": #p10 오류방지
        #     target_selectors = [
        #     "div:nth-child(1001) > div.css-vbvoj0.e13bai5o0 > div.css-1ecn1de.e13bai5o0 > div.css-o3enub.e1umgzx81 > div.css-4ku0lv.e13bai5o0 > p",
        #     "div > p.zds4_s96ru86.zds4_s96ru818.css-sdnfp7.efip69o1 > div > div > p > span:nth-child(1)", #봇
        # ]
        ...
        while not found:
            try:
                ...
                # 30분 초과 확인
                elapsed_time = time.time() - scroll_start
                if elapsed_time > 1800:  # 1800초 = 30분
                    print("30분 이상 경과. 스크롤 작업을 중단합니다.")
                    break
        ...
        df.to_csv(f"{save_path}/후드_p{product_num}_{product_id}.csv", index=False, encoding="utf-8-sig")
